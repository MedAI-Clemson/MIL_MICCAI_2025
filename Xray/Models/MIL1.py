...
parser.add_argument("--save_dir", type=str, default="/home/xiaofey/xray/xray-master/code/saved_models_MIL1",
                    help="Directory to save model checkpoints")
parser.add_argument("--plot_dir", type=str, default="/home/xiaofey/xray/xray-master/code/saved_models_MIL1",
...
class ModifiedModel(nn.Module):
    def __init__(self, pretrained_model_path = None, num_classes=3, in_chans=1, dropout=0.3):
        ...
        model = timm.create_model('resnet50d', pretrained=True, num_classes=num_classes, in_chans=in_chans, drop_rate=dropout)
        ...
        self.fc = nn.Linear(self.M, num_classes)
...
with open('MIL1_roc_auc_scores.pkl', 'wb') as f:  
...
with open('MIL1_metric_results.txt', 'w') as f:
    for metric in metrics:
        scores, mean, std = process_metric(metric)
        results[metric] = {
            'scores': scores,
...
print("All metrics processed and saved to MIL1_metric_results.txt")