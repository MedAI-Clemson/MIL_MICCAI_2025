...
parser.add_argument("--save_dir", type=str, default="/home/xiaofey/xray/xray-master/code/saved_models_MIL2",
                    help="Directory to save model checkpoints")
parser.add_argument("--plot_dir", type=str, default="/home/xiaofey/xray/xray-master/code/saved_models_MIL2",
...
with open('MIL2_roc_auc_scores.pkl', 'wb') as f:  # Change MIL1 to MIL2, MIL3, etc. for each file
...
with open('MIL2_metric_results.txt', 'w') as f:
    for metric in metrics:
        scores, mean, std = process_metric(metric)
        results[metric] = {
            'scores': scores,
...
print("All metrics processed and saved to MIL2_metric_results.txt")